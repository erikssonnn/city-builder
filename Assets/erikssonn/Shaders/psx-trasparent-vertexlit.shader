...
Shader "psx/trasparent/vertexlit" {
    Properties {
        ...
        _xMultiplier("X Multiplier", float) = 160
        _yMultiplier("Y Multiplier", float) = 120
    }
    SubShader {
        Tags {
        ...
        Pass {
            ...
            v2f vert(appdata_full v) {
                ...
                vertex.x = floor(_xMultiplier * vertex.x) / _xMultiplier;
                vertex.y = floor(_yMultiplier * vertex.y) / _yMultiplier;
